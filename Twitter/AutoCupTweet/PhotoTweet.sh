...
fswebcam -r 1920x1080 --font sans:50 --top-banner --banner-colour "#FF000000" --line-colour "#FFFF4500" --no-shadow -S 300 --jpeg 100 "/home/chip/photos/dreher/$FILENAME.jpg" 
